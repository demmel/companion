...
describe("SummarizationBubble", () => {
  const mockSummarizationContent: SummarizationContent = {
    ...
    summary:
      "User and assistant discussed various topics including weather preferences, favorite foods, and upcoming travel plans. The conversation covered seasonal preferences and dietary restrictions.",
  };
  ...
  it("should render summarization bubble with title", () => {
    ...
    expect(
      screen.getByText(
        "✅ Summarized 8 messages. Context usage: 85.2% → 42.1%",
      ),
    ).toBeInTheDocument();
  });
  ...
  it("should start collapsed and show expand arrow", () => {
    ...
    expect(
      screen.queryByText(/weather preferences, favorite foods/),
  ...
  it("should expand when clicked and show summary content", () => {
    ...
    const titleButton = screen.getByText(
      "✅ Summarized 8 messages. Context usage: 85.2% → 42.1%",
    );
    ...
    expect(
      screen.getByText(/weather preferences, favorite foods/),
    ).toBeInTheDocument();
  ...
  it("should display correct context usage statistics", () => {
    ...
    expect(
      screen.getByText(
        "✅ Summarized 12 messages. Context usage: 95.7% → 28.4%",
      ),
    ).toBeInTheDocument();
  });
