...
class BaseAction(ABC):
    ...
    @abstractmethod
    def execute(self, action_plan: ActionPlan, context: ExecutionContext, 
                state: 'State', conversation_history: 'ConversationHistory', 
                llm: 'LLM', model: 'SupportedModel') -> ActionResult:
        """Execute the action and return result"""
        pass
    
    def serialize_conversation_history(self, conversation_history: 'ConversationHistory') -> str:
