...
from agent.types import Message, UserMessage, AgentMessage, TextContent, ThoughtContent, ToolCallFinished, ToolCallSuccess, TextToolContent
...
class TriggerHistory:
    ...
    def get_recent_entries(self, count: int = 10) -> List[TriggerHistoryEntry]:
        ...
        for entry in self.entries:
            ...
            if entry.actions_taken:
                ...
                for action in entry.actions_taken:
                    if action.action == ActionType.THINK:
                    ...
                    elif action.action in [ActionType.UPDATE_APPEARANCE, ActionType.UPDATE_MOOD]:
                        ...
                        tool_calls.append(ToolCallFinished(
